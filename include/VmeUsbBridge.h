...
public:
     ...
     void setMode(const AddressModifier AM, const DataWidth DW);
     UsbController* mode(const AddressModifier AM, const DataWidth DW);
     AddressModifier getAM() const;
     DataWidth getDW() const;
     void setAM(AddressModifier AM);
     void setDW(DataWidth DW);

     int writeData(const long unsigned int address,const void* const data) const;
     int readData(const long unsigned int address,void* const data) const;
     ...
     void IRQDisable(unit32_t mask) const;
...
class V1718Pulser
{
  public:
    ...
    unsigned char getPeriod() const { return this->period; }
    ...
    CVTimeUnits getUnits() const { return this->units; }
...
class V1718Scaler
{
  public:
    ...
    void setResetSource() { this->reset_ = source; this->configured_=false; }
